            ...
            <div className="flex">
                ...
                <div className="pt-12 pl-80 w-full">
                    <div className="flex items-center">
                        <Image
                            src={'/image/giovanna_freitas.png'}
                            width={100}
                            height={50}
                            alt='Giovanna Freitas'
                        ...
                        <ul className="ml-8">
                            ...
                            <li className="flex">
                                <a href="https://github.com/giovannfs" target={"_blank"} className="mr-4">
                                    <Image
                                ...
                                <a href="https://github.com/giovannfs" target={"_blank"}>
                                    <Image
